...
//        }
    ...
    private function setViewerStyle():void
    {
        ...
        var cssStyleDeclarationWT:CSSStyleDeclaration = topLevelStyleManager.getStyleDeclaration("cn.seisys.SGGISViewer.WidgetTemplate");
        ...
        if (numberOfStyleColors > 4)
        {
            cssStyleDeclarationWidgetTitle.setStyle("color", textColor);
        }
